                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                <button 
                                                    x-data
                                                    x-on:click.prevent="
                                                    $dispatch('open-modal', 'modal-edit-recurring-transaction')
                                                    $dispatch('edit-recurring-transaction', { id: {{ $item->id }} })
                                                    "
                                                ...
                                                <button 
                                                    x-data
                                                    x-on:click.prevent="
                                                    $dispatch('open-modal', 'modal-delete-recurring-transaction')
                                                    $dispatch('delete-recurring-transaction', { id: {{ $item->id }} })
                                                    "
